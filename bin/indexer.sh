...
if [[ "$?" != "0" ]]; then
	...
	if [ `ls -lad "/home/pi/log/gudanews_indexer.log" | awk '{print $5}'` -gt 1000000 ]; then mv /home/pi/log/gudanews_indexer.log "/home/pi/log/gudanews_indexer_`date '+%Y-%m-%d_%H-%M'`.log"; fi
